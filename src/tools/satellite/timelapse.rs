...
pub fn generate_4d_timelapse(
    ...
    let sensor_type = if sensor.to_lowercase().contains("radar") || sensor.to_lowercase().contains("s1") {
        "radar_s1"
    } else {
        "optik_s2"
    };
    ...
    match Command::new("python3")
        ...
        .arg("--start_year").arg(start_year.to_string())
        .arg("--end_year").arg(end_year.to_string())
        .arg("--sensor").arg(sensor_type)
