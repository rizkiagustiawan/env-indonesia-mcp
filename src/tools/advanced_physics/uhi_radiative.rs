...
pub fn calculate_uhi(
    ...
    if albedo_urban < 0.0 || albedo_urban > 1.0 {
        return "ERROR: Albedo harus di antara 0.0 (menyerap semua) dan 1.0 (memantulkan semua)."
            .into();
    }
    ...
    if delta_t > 3.0 {
        ...
        out.push_str(
            "   -> Solusi: Cat atap warna putih (tingkatkan albedo) atau tanam vegetasi atap.\n",
        );
    } else {
