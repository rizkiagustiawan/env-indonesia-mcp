...
pub fn lookup(topic: &str) -> String {
    ...
    let regs: Vec<Reg> = vec![
        ...
        Reg { nomor: "PP 22/2021 (mencabut PP 82/2001)", judul: "Pengelolaan Kualitas Air dan Pengendalian Pencemaran Air", topik: &["air", "sungai", "pencemaran_air", "baku_mutu_air", "limbah"] },
        ...
        Reg { nomor: "PermenLHK 11/2025", judul: "Baku Mutu Air Limbah Domestik (menggantikan PermenLHK 68/2016)", topik: &["air", "limbah", "domestik", "air_limbah"] },
        ...
        Reg { nomor: "PermenLHK P.14/2020", judul: "ISPU (Indeks Standar Pencemar Udara)", topik: &["udara", "ispu", "kualitas_udara", "aqi"] },
        ...
        Reg { nomor: "PermenLHK P.27/2021", judul: "IKLH (Indeks Kualitas Lingkungan Hidup)", topik: &["iklh", "ika", "iku", "iktl", "kualitas_lingkungan"] },
        ...
        Reg { nomor: "PP 28/2025", judul: "Persetujuan Lingkungan (menggantikan Izin Lingkungan PP 27/2012)", topik: &["izin", "amdal", "ukl_upl", "lingkungan", "persetujuan_lingkungan"] },
        Reg { nomor: "KepMen LH 51/2004", judul: "Baku Mutu Air Laut", topik: &["laut", "air_laut", "marine", "pesisir"] },
